<template>
  <ul class="r-text-component">
    <li class="clearfix r-text-item" style="border-bottom:1px solid #D3D9E6">
      <span class="theLabel">
        是否显示按钮：
      </span>
      <span class="theValue">
    ...
    <a-row type="flex" justify="center" align="middle">
      <a-col :span="16">
        <div style="height:120px;border:1px solid #D3D9E6;border-radius:6px" v-if="theRadio == '0'">
        ...
        <div style="height:120px;border:1px solid #D3D9E6;border-radius:6px" v-if="theRadio == '1'">
          <uploadImg
            :size="'250*250'"
            :space="10"
